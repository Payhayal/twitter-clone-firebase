    ...
    <section className="h-screen bg-zinc-700 grid place-items-center">
      <div className="bg-black text-white flex flex-col gap-10 py-16 px-32 rounded-lg">
        ...
        <div
          ...
          className="flex items-center bg-white rounded-full cursor-pointer py-2 px-10 gap-3 hover:bg-gray-300"
        >
        ...
        <h3 className="relative top-[50px] bg-black w-28 text-center ml-20">
          or
        </h3>
        <hr />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <input
            autoComplete="e-mail"
            className="text-black mt-1 rounded p-2 shadow-lg "
            type="e-mail"
          />
